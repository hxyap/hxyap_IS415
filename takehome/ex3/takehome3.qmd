...
Thanks for following along. We also have a shinyapp for you to explore and export our data, and to play and interact with our visualizations. For further reading, do read into the PPDB which explains the zoning policy in Indonesia, with its fair share of criticism on equity. We drew similar inspiration from its measures (accessibility, density, commute) etc to construct a simpler but hopefully similar model, and I hope this has inspired you and helped you learn about about how decisions are made when it comes to investing and implementing policy to uplift youths.
